...
describe 'Usuario consulta Orçamentos' do
    ...
    it 'e ve suas Ordens de Entrega não Iniciada' do
        ...
        order2 = Order.create!(code: 'ZZZ1234567890ZZ', product_code: 'Produto_B', description: 'Produto  perecivel', 
                ...
                sender_name: 'Clara Severo', sender_identification: 22345678901, sender_email: 'clara@email.com',
                ...
                recipient_identification: 56729965704, recipient_email: 'lins@email.com', recipient_phone: '21 988885467',
